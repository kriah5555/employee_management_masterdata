...
class ContractConfigurationService extends BaseService
{
    ...
    {
        parent::__construct(ContractConfiguration::class);
    }
    ...
    public function updateContractConfigurations($values)
    {
        try {
            DB::connection('tenant')->beginTransaction();
                ...
                $this->model::whereNotIn('employee_type_id', $validEmployeeTypeIds)->delete();
