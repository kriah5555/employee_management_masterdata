...
class EmployeeProfileRepository implements EmployeeProfileRepositoryInterface
{
    ...
    public function createEmployeeProfile(array $employeeProfileDetails): EmployeeProfile
    {
        return EmployeeProfile::updateOrCreate(
            ...
            [
                'responsible_person_id' => isset($employeeProfileDetails['responsible_person_id']) ? $employeeProfileDetails['responsible_person_id'] : null,
            ]
        );
    ...
    public function getEmployeeResponsiblePersonId(array $employee_profile_id)
    {
        ...
        if ($employee_profile) {
            return $employee_profile->responsible_person_id;
        }
        return null;
    }
