...
class RuleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $rules = [
            ...
            [
                'name'        => 'RULE_2H',
                'description' => "Minimum hours an employee(below 18) is allowed to work per week",
                'type'        => 2,
                'value_type'  => 2,
                'value'       => '13'
            ],
            ...
            [
                'name'        => 'RULE_3C',
                'description' => "When an employee did NOT enter stop working on time : after how many minutes (after the planned stop time) do you (as manager) want to receive an alert (email) that employee did not enter stop working?",
                'type'        => 3,
                'value_type'  => 1,
                'value'       => '15'
            ],
